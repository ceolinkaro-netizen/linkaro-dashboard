...
const additionalPolicies = [
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Google Play Subscriptions & Auto-Renewal", body: "Subscriptions purchased through Google Play automatically renew at the end of each billing period unless cancelled at least 24 hours before the renewal date. Cancellation and refund requests for Google Play subscriptions are subject to Google Play's billing and refund policies and must be submitted through Google Play's support channels. Manual subscriptions processed outside of Google Play do not auto-renew." },
